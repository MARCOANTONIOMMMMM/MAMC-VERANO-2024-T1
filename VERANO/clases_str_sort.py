def clases_str_sort(datos_formated):
    """
    Función para ordenar alfabéticamente una lista de strings.
    
    Parámetros:
    - datos_formated (list): lista de strings que representan los datos formateados
    
    Lo que hace:
    - Ordena la lista de strings alfabéticamente en orden ascendente
    ...
    # Ordenar la lista de strings alfabéticamente en orden ascendente
    datos_formated.sort() 
